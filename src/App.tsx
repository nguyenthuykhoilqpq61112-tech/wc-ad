...
const wheelIncomes: WheelIncome[] = [
  ...
  {date: "2026-09-06", amount: 30, source: "Wheel game", status: "Settled"},
];
    ...
    <section className="page-grid league-bets-page">
      <section className="league-bets-hero">
        <div>
          ...
          <h2>五大联赛投注中心</h2>
          <span>集中管理单场、串关、滚球、球员道具和球队道具投注。联赛收入按收款流水入账：8.22 为 208u，8.23 为 85u，8.24 为 60u，8.25 为 95u，8.26 为 50u，8.27 为 30u，8.28 为 240u，8.29 为 105u，8.31 为 55u，9.1 为 50u，9.5 为 50u，合计 1075u。</span>
        </div>
  ...
  return (
    <section className="wallet-band">
      <div>
        ...
        <h2>{platformBalance.toLocaleString()}u available after 2026-09-06 early morning wheel game income</h2>
